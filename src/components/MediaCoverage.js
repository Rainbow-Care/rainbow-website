  ...
  return (
    <section className={cx(className, 'container mx-auto')}>
      ...
      <div className='flex flex-col md:flex-row gap-8 md:gap-x-4 justify-between place-items-center mt-16'>
        <img src='/images/lokmat.svg' className={imgClass} alt='Lokmat New Paper Icon'></img>
        <img src='/images/sakal.svg' className={imgClass} alt='Sakal New Paper Icon'></img>
        <img src='/images/abp.svg' className={imgClass} alt='ABP Majha Icon'></img>
        <img
          className={imgClass}
